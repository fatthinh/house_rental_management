            ...
            <div className="float-right h-screen duration-1000 ease-in-out transition-all bg-white md:w-400 p-8">
                <div className="flex justify-between items-center">
                    ...
                    <Button
                        ...
                        size="2xl"
                        borderRadius="50%"
                        onClick={() => dispatch(appSlice.actions.handleClick('chat'))}
                    />
                </div>
                ...
                <div className="mt-5 overflow-auto max-h-screen">
                    {chatData?.map((item, index) => (
                        <div key={index} className="flex items-center leading-8 gap-5 border-b-1 border-color py-3 pr-3">
                            <div className="">
                                {/* User Image */}
                                <img
                                    className="rounded-full h-10 w-10"
                                    src="https://www.svgrepo.com/show/355640/check-circle-solid.svg"
                                    alt={item.message}
                                />
                            </div>
